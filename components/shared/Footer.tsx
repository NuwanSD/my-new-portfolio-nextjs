    ...
    <footer className="w-full pb-10 mb-[100px] md:mb-5" id="contact">
      ...
      <div className="flex flex-col items-center">
        <h1 className="heading lg:max-w-[45vw]">
          Rady to take <span className=" text-purple">your</span> digital
          presence to the next level?
        </h1>
        <p className=" text-white-200 md:mt-10 my-5 text-center">
          Reach out to me and let's discuss how I can help yuo acheive your
          goals.
        </p>
        <Link href="sagaradnuwan@gmail.com">
          <MagicButton
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center gap-3">
        <p className="md:text-base text-sm md:font-normal font-light">
          Copyright &copy; {new Date().getFullYear()} Sagara
        </p>
